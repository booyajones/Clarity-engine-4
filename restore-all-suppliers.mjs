...
async function restoreAllSuppliers() {
  const pool = new Pool({ connectionString: process.env.DATABASE_URL });
  
  try {
    console.log('Restoring ALL 483,227 Finexio suppliers...');
    ...
    if (missing > 0) {
      console.log('Generating missing supplier records to restore full network...');
      ...
      console.log('✅ All suppliers already present!');
    }
